              ...
              >
                ...
                >
                  <span className="relative inline-block">
                    ABOUT
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-accent-500/20 to-accent-600/20 -skew-x-12"
                      initial={{ scaleX: 0 }}
                  ...
                  <span className="relative inline-block">
                    TOOLHUB
                    <motion.div
                      className="absolute -bottom-4 left-0 w-full h-2 bg-accent-500"
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
              ...
              >
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    {/* Hover Glow Effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-accent-500/20 to-accent-600/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl" />
                  </motion.div>
                ))}
              </motion.div>
            </motion.div>
