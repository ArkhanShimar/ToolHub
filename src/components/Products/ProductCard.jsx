...
export default function ProductCard({ product, viewMode = 'grid' }) {
  ...
  return (
    ...
    >
      <Link href={`/products/${product.slug || product._id}`}>
        {/* Image Container */}
        <div className="relative w-full h-48 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 flex-shrink-0">
          {/* Badges */}
          <div className="absolute top-3 left-3 z-20 flex flex-col gap-2">
            ...
            {product.featured && (
              <div className="bg-accent-500 text-white px-2 py-1 rounded-lg text-xs font-bold shadow-lg flex items-center gap-1">
          ...
          <div className="absolute top-3 right-3 z-20">
            <div className={`px-2 py-1 rounded-lg text-xs font-bold shadow-lg flex items-center gap-1 ${
              product.stockQty > 0 
          ...
          <div className="absolute bottom-3 right-3 z-20 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
            ...
            <motion.button
              onClick={handleAddToCart}
              disabled={product.stockQty === 0}
              className="p-2 bg-accent-500 text-white rounded-full shadow-lg hover:bg-accent-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
        ...
        <div className="p-4 flex-1 flex flex-col justify-between">
          <div className="flex-1">
            {/* Brand */}
            {product.brand && (
              <p className="text-xs text-accent-500 uppercase tracking-wider font-bold mb-2 flex items-center gap-1">
            ...
            {/* Product Name */}
            <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-accent-600 transition-colors text-sm leading-tight">
              {product.name}
            </h3>
